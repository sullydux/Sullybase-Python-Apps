...
- These scripts were made with AIs and have been tested to work.
- These scripts use Python 3.14.5 and run on Apple Silicon.
- Unless stated or inferred they do not use a network connection.
- I am not able to pay, so all of the apps are unsigned meaning you have to bypass Gatekeeper to open them.
- The apps are just the Python script made into a `.app` by py2app.
...
By using this software you agree to using AI made scripts and images which have some errors.